// $Id: $
export function zf_ValidateAndSubmit() {
...
export function zf_CheckMandatory() {
...
export function zf_ShowErrorMsg(uniqName) {
  var fldLinkName;
...
export function zf_ValidateNumber(elem) {
...
export function zf_ValidateDateFormat(inpElem) {
...
export function zf_ValidateCurrency(elem) {
  var validChars = "0123456789.";
  var numValue = elem.value.replace(/^\s+|\s+$/g, "");
...
export function zf_ValidateDecimalLength(elem, decimalLen) {
...
export function zf_ValidateEmailID(elem) {
  var check = 0;
...
export function zf_ValidateLiveUrl(elem) {
...
export function zf_ValidatePhone(inpElem) {
  var ZFPhoneRegex = {
...
export function zf_ValidateSignature(objElem) {
...
export function zf_MandatoryCheckSignature(objElem) {
  var linkName = objElem.getAttribute("compname");
  var canvasElem = document.getElementById("drawingCanvas-" + linkName);
...
export function zf_IsSignaturePresent(objElem, linkName, canvasElem) {
...
export function zf_FocusNext(elem, event) {
...
export function zf_ValidateMonthYearFormat(inpElem) {
